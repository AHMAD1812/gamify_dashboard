<template>
  <header class="header clearfix">
    ...
    <div class="main_logo" id="logo">
        <a href="index.html"><img src="images/gamify.png" alt="" width="140" /></a>
        <a href="index.html"><img class="logo-inverse" src="images/gamifyfav.png" alt="" /></a>
    </div>
    ...
    <div class="header_right">
        <ul>
            <li>
                <a href="create_new_course.html" class="upload_btn" title="Create New Course">Create New Video</a>
            </li>
            ...
            <li class="ui dropdown">
                ...
                <div class="menu dropdown_account left visible">
                    <div class="channel_my">
                        ...
                        <a href="my_instructor_profile_view.html" class="dp_link_12 mt-2 text-center">View Instructor
                            Profile</a>
                    </div>
                    ...
                    <a href="instructor_dashboard.html" class="item channel_item">Gamify Us dashboard</a>
