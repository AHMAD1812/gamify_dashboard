...
<section class="min">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-8">
                <div class="sec-heading center">
                    <h2>Purpose of <span class="theme-cl">Gamification</span></h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blg_grid_box">
                    ...
                    <div class="blg_grid_caption">
                        ...
                        <div class="blg_title"><h4><a href="blogs.html">Our Main motive is Brainstrom our student. They should be able to thionk out of the box.</a></h4></div>
                        ...
                        <div class="blg_more"><a href="blogs.html">Reading Continues</a></div>
                    </div>
                </div>
            </div>
...
<section class="min gray">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-8">
                <div class="sec-heading center">
                    <h2>Latest Blogs & <span class="theme-cl">Articles</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="blg_grid_box">
                    ...
                    <div class="blg_grid_caption">
                        ...
                        <div class="blg_title"><h4><a href="blogs.html">How To Register & Enrolled on SkillUp Step by Step?</a></h4></div>
                        <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</p></div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="blg_grid_box">
                    ...
                    <div class="blg_grid_caption">
                        ...
                        <div class="blg_title"><h4><a href="blogs.html">Let's Know How Skillup Work Fast and Secure?</a></h4></div>
                        <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</p></div>
                    </div>
                    <div class="crs_grid_foot">
                        <div class="crs_flex">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="blg_grid_box">
                    ...
                    <div class="blg_grid_caption">
                        ...
                        <div class="blg_title"><h4><a href="blogs.html">How To Improove Digital Marketing for Fast SEO</a></h4></div>
                        <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</p></div>
                    </div>
                    <div class="crs_grid_foot">
                        <div class="crs_flex">
